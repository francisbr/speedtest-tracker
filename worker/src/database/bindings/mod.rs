...
pub mod bandwidth_type;
pub mod delete_speedtest_reducer;
pub mod interface_type;
pub mod latency_type;
pub mod ping_type;
pub mod record_speedtest_reducer;
pub mod server_type;
pub mod speedtest_result_type;
pub mod speedtest_table;

pub use bandwidth_type::Bandwidth;
pub use delete_speedtest_reducer::{
    delete_speedtest, set_flags_for_delete_speedtest, DeleteSpeedtestCallbackId,
};
pub use interface_type::Interface;
pub use latency_type::Latency;
pub use ping_type::Ping;
pub use record_speedtest_reducer::{
    record_speedtest, set_flags_for_record_speedtest, RecordSpeedtestCallbackId,
};
pub use server_type::Server;
pub use speedtest_result_type::SpeedtestResult;
pub use speedtest_table::*;
...
pub enum Reducer {
    DeleteSpeedtest { id: String },
    RecordSpeedtest { speedtest: SpeedtestResult },
}
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            Reducer::DeleteSpeedtest { .. } => "delete_speedtest",
            Reducer::RecordSpeedtest { .. } => "record_speedtest",
        }
    }
}
impl TryFrom<__ws::ReducerCallInfo<__ws::BsatnFormat>> for Reducer {
    ...
    fn try_from(value: __ws::ReducerCallInfo<__ws::BsatnFormat>) -> __sdk::Result<Self> {
        match &value.reducer_name[..] {
            "delete_speedtest" => Ok(__sdk::parse_reducer_args::<
                delete_speedtest_reducer::DeleteSpeedtestArgs,
            >("delete_speedtest", &value.args)?
            .into()),
            "record_speedtest" => Ok(__sdk::parse_reducer_args::<
                record_speedtest_reducer::RecordSpeedtestArgs,
            >("record_speedtest", &value.args)?
            .into()),
            unknown => {
                Err(
...
#[doc(hidden)]
pub struct DbUpdate {
    speedtest: __sdk::TableUpdate<SpeedtestResult>,
}
    ...
    fn try_from(raw: __ws::DatabaseUpdate<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        ...
        for table_update in raw.tables {
            match &table_update.table_name[..] {
                "speedtest" => {
                    db_update.speedtest = speedtest_table::parse_table_update(table_update)?
                }
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.speedtest = cache
            .apply_diff_to_table::<SpeedtestResult>("speedtest", &self.speedtest)
...
pub struct AppliedDiff<'r> {
    speedtest: __sdk::TableAppliedDiff<'r, SpeedtestResult>,
}
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<SpeedtestResult>(
            "speedtest",
            &self.speedtest,
            event,
        );
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        speedtest_table::register_table(client_cache);
    }
}
